...
public class SamiNavMenu extends FrameLayout
{
    ...
    private List<SamiNavBtn> leftMenuItems;
    private List<SamiNavBtn> rightMenuItems;
    ...
    public SamiNavMenu(Context context)
    {
        super(context);
        initViews(context, -1, -1);

        this.attachToActivity((Activity)context);
        this.openMenu(DIRECTION_RIGHT);
        this.closeMenu();
     ...
     */
    public SamiNavMenu(Context context, int customLeftMenuId,
    ...
    private void initValue(Activity activity) {
        ...
        leftMenuItems = new ArrayList<SamiNavBtn>();
        rightMenuItems = new ArrayList<SamiNavBtn>();
     ...
     */
    @Deprecated
    public void addMenuItem(SamiNavBtn menuItem) {
     ...
     * @param direction
     */
    public void addBtn(SamiNavBtn menuItem, int direction) {
    ...
    public void addBtnRight(SamiNavBtn menuItem)
    {
        this.rightMenuItems.add(menuItem);
        layoutRightMenu.addView(menuItem);
    }
    public void addBtnLeft(SamiNavBtn menuItem)
    {
        this.leftMenuItems.add(menuItem);
        layoutLeftMenu.addView(menuItem);
    }
     ...
     */
    @Deprecated
    public void setMenuItems(List<SamiNavBtn> menuItems) {
     ...
     * @param direction
     */
    public void setMenuItems(List<SamiNavBtn> menuItems, int direction) {
        if (direction == DIRECTION_LEFT)
            this.leftMenuItems = menuItems;
        else
     ...
     */
    @Deprecated
    public List<SamiNavBtn> getMenuItems() {
     ...
     * @return
     */
    public List<SamiNavBtn> getMenuItems(int direction) {
        if (direction == DIRECTION_LEFT)
            return leftMenuItems;
        else
    ...
    public void disSwipeRight()
    {
        disabledSwipeDirection.add(LAYOUT_DIRECTION_RTL);
    }
    public void disSwipeLeft()
    {
        disabledSwipeDirection.add(LAYOUT_DIRECTION_LTR);
    }
